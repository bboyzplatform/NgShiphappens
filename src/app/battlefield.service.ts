...
export class BattlefieldService {
  ...
  createBoard(size: number = 5): BattlefieldService {
  ...
  randomShips(tiles: Object[], len: number): Object[] {
    len = len - 1;
    // tslint:disable-next-line:prefer-const
    let ranRow = this.getRandomInt(0, len), ranCol = this.getRandomInt(0, len);
